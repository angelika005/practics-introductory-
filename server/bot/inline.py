...
check = {'Менеджер по продажам': 'Менеджер по продажам, менеджер по работе с клиентами', 'Автослесарь': 'Автослесарь, автомеханик',
            'Оформление по ГПХ':'Оформление по ГПХ или по совместительству',
